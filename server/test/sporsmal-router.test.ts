...
const testQuestions: Sporsmal[] = [
	{
		sporsmalid: 1,
		tittel: "How to create a database schema?",
		innhold: "I need help with designing a database schema for my project.",
		poeng: 10,
		dato: roundedDate,
	...
	{
		sporsmalid: 2,
		tittel: "What are TypeScript interfaces?",
		innhold:
			"I want to understand interfaces in TypeScript. Can someone explain?",
		poeng: 8,
		dato: roundedDate,
		sistendret: roundedDate,
		bestsvarid: null,
	...
	{
		sporsmalid: 3,
		tittel: "How to use async/await in JavaScript?",
		innhold:
			"I am having trouble understanding asynchronous programming. Any examples?",
		poeng: 12,
		dato: roundedDate,
		sistendret: roundedDate,
		bestsvarid: null,
	...
	{
		sporsmalid: 4,
		tittel: "Test after updating structure of database",
		innhold:
			"I updated the database structure, and need to test a little extra to ensure nothing is wrong.",
		poeng: 12,
		dato: roundedDate,
		sistendret: roundedDate,
		bestsvarid: null,
...
describe("Fetch questions (GET)", () => {
	...
	test("Fetch question (404 Not Found)", (done) => {
		//Working
		axios
			.get("/sporsmal/5")
